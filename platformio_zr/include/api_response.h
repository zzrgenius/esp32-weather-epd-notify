...
#define OWM_NUM_DAILY          7 // 8
#define OWM_NUM_ALERTS         8 // OpenWeatherMaps does not specify a limit, but if you need more alerts you are probably doomed.
#define OWM_NUM_AIR_POLLUTION 1 // Depending on AQI scale, hourly concentrations will need to be averaged over a period of 1h to 24h
...
DeserializationError deserializenowQweather( String sjson,   owm_resp_onecall_t &r);
DeserializationError deserializeHourQweather( String sjson,   owm_resp_onecall_t &r);
...
DeserializationError deserializeAirQualityQweather( String sjson, owm_resp_air_pollution_t &r);
