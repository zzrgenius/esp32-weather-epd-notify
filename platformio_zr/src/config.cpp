...
// WIFI
const char *WIFI_SSID     = "FH_NODE";
const char *WIFI_PASSWORD = "Wisdom:5721";
...
// const String OWM_APIKEY   = "db77901d6dc77990835b465fd029adf9";
...
const String OWM_APIKEY   = "c1ff043362be465b8f56486df917a35c";
const String OWM_ENDPOINT = "devapi.qweather.com";
...
const String LOCATION_CODE = "101190109";

// LOCATION
// Set your latitude and longitude.
// (used to get weather data as part of API requests to OpenWeatherMap)
const String LAT = "31.9628";
const String LON = "118.7960";
// City name that will be shown in the top-right corner of the display.
const String CITY_STRING = "NanJing";
const String LOVE_STRING = "QLucky";
